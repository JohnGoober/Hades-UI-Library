...
UserInterface.Settings.MainColor = Color3.fromRGB(255, 50, 50)
UserInterface.Settings.SecondaryColor = Color3.fromRGB(255, 100, 100)
UserInterface.Initialize()

local MainForm = UserInterface.CreateWindow("Form", "Main_Form", Enum.KeyCode.RightAlt, false, "Main", UDim2.fromOffset(200, 200), UDim2.fromOffset(450, 450), false)

MainForm:Create("Page", "AimPage", "rbxassetid://4670925585")

MainForm.AimPage:Create("Group", "AimGroup", "Aim")

MainForm.AimPage.AimGroup:Create("Check", "TestCheck", "Check")
MainForm.AimPage.AimGroup.TestCheck:Create("Color", "TestColor", Color3.fromRGB(255, 255, 255))

MainForm.AimPage.AimGroup:Create("Button", "TestButton", "Button")
MainForm.AimPage.AimGroup.TestButton:Create("Color", "TestColor", Color3.fromRGB(255, 255, 255))

MainForm.AimPage.AimGroup:Create("Textbox", "TestTextBox", "Textbox")
MainForm.AimPage.AimGroup:Create("Slider", "TestSlider", 0, 255, 25)

MainForm.AimPage.AimGroup:Create("Combobox", "TestCombobox", "Combobox", true)
MainForm.AimPage.AimGroup.TestCombobox:Create("Check", "TestCheck1", "Check1")
MainForm.AimPage.AimGroup.TestCombobox:Create("Check", "TestCheck2", "Check2")
MainForm.AimPage.AimGroup.TestCombobox:Create("Check", "TestCheck3", "Check3")
MainForm.AimPage.AimGroup.TestCombobox:Create("Check", "TestCheck4", "Check4")

MainForm:Create("Page", "VisualPage", "rbxassetid://4670925071")
MainForm.VisualPage:Create("Group", "VisualGroup", "Visual")
MainForm.VisualPage.VisualGroup:Create("Check", "TestCheck", "Check")

MainForm:Create("Page", "MiscPage", "rbxassetid://4670923865")
MainForm.MiscPage:Create("Group", "MiscGroup", "Misc")

MainForm:Create("Page", "ConfigPage", "rbxassetid://4670922903")
MainForm.ConfigPage:Create("Group", "ConfigGroup", "Config")